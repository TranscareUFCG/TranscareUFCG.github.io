import { Box, Center, HStack, Link, Text,Image } from "native-base";
            ...
            <Box marginTop={12} marginBottom={12}>
              <HStack marginBottom={2} justifyContent={"flex-start"}>
                <TouchableOpacity activeOpacity={0.5}>
                  <Link
                    href="https://www.youtube.com/channel/UCJvYAzFOh9BEP5gt6SB4CmA"
                    isExternal
                  >
                    <Box marginRight={2}>
                      <Image size="md" source={require(`./imgs/youtube.png`)} />
                    </Box>
                  </Link>
                </TouchableOpacity>
                <TouchableOpacity activeOpacity={0.5}>
                  <Link href="https://www.instagram.com/laticsufcg/" isExternal>
                    <Box marginRight={2}>
                      <Image size="md" source={require(`./imgs/Instagram.png`)} />
                    </Box>
                  </Link>
                </TouchableOpacity>
                <TouchableOpacity activeOpacity={0.5}>
                  <Link href="https://www.facebook.com/laticsufcg" isExternal>
                    <Box marginRight={3}>
                      <Image size="md" source={require(`./imgs/Facebook.png`)} />
                    </Box>
                  </Link>
                </TouchableOpacity>
              </HStack>
              <TouchableOpacity activeOpacity={0.5}>
                <Link href="http://laticsufcg.blogspot.com/" isExternal>
                  <Image size="md" source={require(`./imgs/Blogger.png`)} />
                </Link>
              </TouchableOpacity>
            </Box>
            <Center>
              <Image size="xl" source={require(`./imgs/logo.png`)} />
            </Center>
          </Box>
        </ScrollView>
      </Container>
