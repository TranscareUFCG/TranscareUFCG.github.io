      ...
      <ContainerUniverses>
        ...
        <ScrollView>
          <Box padding={4}>
            ...
            <Center>
              <Image resizeMode={"contain"} size="2xl"  source={require(`./imgs/1.png`)} />
            </Center>
            ...
            <Center marginTop={5}>
              <Image resizeMode={"contain"} size="2xl"  source={require(`./imgs/2.png`)} />
            </Center>
            <Text
              marginTop={3}
              color={"#FF83A8"}
            ...
            <Center marginTop={5}>
              <Image resizeMode={"contain"} size="2xl"  source={require(`./imgs/3.png`)} />
            </Center>
          </Box>
        </ScrollView>
      </ContainerUniverses>
